      ...
      <div className="max-w-[1440px] mx-auto pt-10 space-y-10">
        ...
        <div>
          <div className="grid grid-cols-1 grid-rows-2 lg:grid-cols-2 lg:grid-rows-1 gap-4">
            <motion.div
              className="flex justify-between items-center bg-[#3D348B] h-full rounded-4xl p-8 lg:col-span-2"
            ...
            >
              ...
              >
                <Play className="stroke-background fill-background" size={25} />
              </motion.div>
            </motion.div>

            <motion.div
              className="flex justify-between items-center bg-orange-600 h-full rounded-4xl p-8"
              whileHover={{ scale: 1.02 }}
              transition={{ type: "spring", stiffness: 300 }}
            >
              <div>
            ...
            <Link to={"/dashboard/manage-workouts"}>
              <motion.div
                className="flex justify-between items-center gap-2 bg-[#FAF6FA] dark:bg-[#2d2d2d] h-full rounded-4xl p-8"
                whileHover={{ scale: 1.02 }}
                transition={{ type: "spring", stiffness: 300 }}
              >
                <div>
